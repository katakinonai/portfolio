  ...
  return (
    ...
    >
      <motion.div initial="hidden" whileInView="visible">
        <motion.h1 custom={1} variants={textAnimationX}>
          {Content[6].title}
        </motion.h1>
        <Divider />
      </motion.div>
      ...
      <motion.div initial="hidden" whileInView="visible">
        <motion.h2 custom={2} variants={textAnimationX}>
          {Content[6].text[0].title}
        </motion.h2>
      ...
      <motion.div initial="hidden" whileInView="visible">
        ...
        <div>
          {Content[6].text[1].content.map((item) => {
            return (
              <div key={item.id}>
                <p>
                  <span style={{ textDecoration: 'bold' }}>{item.title}</span>: {item.content}
                </p>
              </div>
            );
          })}
        ...
        <motion.div className="education" initial="hidden" whileInView="visible">
          <motion.h2 custom={2} variants={textAnimationX}>
            {Content[6].text[2].title}
          </motion.h2>
